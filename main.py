...
window.title('Manal- Mad Libs Generator')
Label(window, text='Mad Libs Generator \n Have Fun!', font='Verdana 20 bold').pack()
Label(window, text='Click Any One :', font='Verdana 15 bold').place(x=40, y=80)
################Stories##############
def madlib1():
...
######buttons
Button(window, text='The Photographer', font='Verdana 15', command=madlib1, bg='sky blue').place(x=60, y=120)
Button(window, text='apple and apple', font='Verdana 15', command=madlib3, bg='sky blue').place(x=70, y=180)
Button(window, text='The Butterfly', font='Verdana 15', command=madlib2, bg='sky blue').place(x=80, y=240)
